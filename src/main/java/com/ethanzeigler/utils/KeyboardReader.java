 ...
 *
 * @author Ethan Zeigler, class of '16, now at TCNJ for Computer Science
 * @version 1.5
 */
public class KeyboardReader {
     ...
     * @return Integer value of the user input
     */
    public int readInt(String message, int minLimit, int maxLimit) {
        ...
        do {
            ...
            try {
                ...
                if (num >= minLimit && num <= maxLimit) {
                    ...
                    System.out.printf("Invalid input. Input must be between %d and %d.%n", minLimit, maxLimit);
                }
            } catch (IOException e) {
                System.out.println("An IOException occurred:");
                e.printStackTrace();
    ...
    public double readDouble(String message) {
        return this.readDouble(message, Double.MIN_VALUE, Double.MAX_VALUE);
    }
    ...
    public float readFloat(String message) {
        return this.readFloat(message, Float.MIN_VALUE, Float.MAX_VALUE);
    }
